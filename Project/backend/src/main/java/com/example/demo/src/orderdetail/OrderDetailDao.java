...
public class OrderDetailDao {
    ...
    public List<GetOrderDetailRes> getOrderDetails() {
        String getOrderDetailsQuery = "select * from coupang.orderdetail";
    ...
    public List<GetOrderDetailRes> getOrderDetailsByOrderId(Integer OrderId) {
        String getOrderDetailsByOrderIdQuery = "select * from coupang.orderdetail where order_id =?";
    ...
    public GetOrderDetailRes getOrderDetail(int orderDetailId) {
        String getOrderDetailQuery = "select * from coupang.orderdetail where id = ?";
    ...
    public int createOrderDetail(PostOrderDetailReq postOrderDetailReq) {
        String createOrderDetailQuery = "insert into coupang.orderdetail (order_id, product_detail_id, order_detail_unit_price, order_detail_quantity, order_detail_discount, order_detail_price, order_detail_status, delivery_id) VALUES (?,?,?,?,?,?,?,?)";
    ...
    public int modifyOrderDetailStatus(PatchOrderDetailReq patchOrderDetailReq) {
        String modifyOrderDetailStatusQuery = "update coupang.orderdetail set order_detail_status = ? where id = ? ";
    ...
    public int deleteOrderDetail(int orderDetailId) {
        String deleteOrderDetailNameQuery = "update coupang.orderdetail set status = ? where id = ? ";
